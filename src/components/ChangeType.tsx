...
/*
The ChangeType component simulates another an editor for a quiz application that provides a way
 to change the type of a quiz question by pressing a button. 
 Recall from the Objects task that Quiz Questions can come in either 
...
export function ChangeType(): JSX.Element {
    const [question_type, SetQuestion] = useState<QuestionType>(
